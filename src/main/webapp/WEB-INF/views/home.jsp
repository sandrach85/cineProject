...
<body>
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-collapse collapse">
						<ul class="nav navbar-nav">
							...
							<li><a href="<c:url value="/list-actors"/>">Mostrar
									actores</a></li>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				...
				<div class="container">
					<div class="carousel-caption">
						...
						<p>En nuestra escuela de Stand Up Paddle encontrarás los
							cursos para aprender y disfrutar de este deporte en Tarifa además
			...
			<div class="item">
				...
				<div class="container">
					<div class="carousel-caption">
						<h1>Crear pistas</h1>
						<p>Muestra un boton que añade una pista automáticamente</p>
						<p>
		...
		<footer>
			<p>Realizado por Sandra Chacón-UPM-MIW</p>
		</footer>
	</div>
	<!-- ============================= -->
	<script
